...
if __name__ == '__main__':
    ...
    print("--------------------------------------------------------------------------------")
    # 明文
    plaintext = "project_eleven."
    print("ojectext为:", plaintext)
    print("--------------------------------------------------------------------------------")
    # 生成公私钥对
    sk, pk = key_gen()
    # 加密
    ciphertext = SM2_enc(plaintext, pk)
    print("ciphertext为:")
    print("C1:", ciphertext[0])
    print("C2", ciphertext[1])
    print("C3:", ciphertext[2])
    print("--------------------------------------------------------------------------------")
    # 解密
    plaintext_from_ciphertext = SM2_dec(ciphertext, sk)
    print('plaintext from ciphertext为:', plaintext_from_ciphertext)
    print("--------------------------------------------------------------------------------")
    # 判断是否成功解密
    print("是否成功解密:", True if plaintext == plaintext_from_ciphertext else Flase)
    print("--------------------------------------------------------------------------------")
    print("                                验证签名                                ")
    print("--------------------------------------------------------------------------------")
    msg = "sdu_cst_project."
    ...
    print("--------------------------------------------------------------------------------")
    ZA = precompute(ID, A, B, G_X, G_Y, pk[0], pk[1])
    signature = sm2_sign(sk, msg, str(ZA))
    print("signature为:")
    print(signature)
    print("--------------------------------------------------------------------------------")
    # 验签
    print("signature是否合法:", sm2_verify(pk, ID, msg, signature))
